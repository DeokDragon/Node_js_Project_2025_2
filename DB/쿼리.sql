...
('hero412', 'hero1523@gmail.com', 'hashed_password5'),
('hero1231', 'hero1231@gmail.com', 'hashed_password2'),
('hero1232', 'hero1232@gmail.com', 'hashed_password3'),
('hero1233', 'hero1233@gmail.com', 'hashed_password4'),
('hero123', 'hero123@gmail.com', 'hashed_password1')
...
-- 6. 조건에 맞는 플레이어 검색
SELECT username, email FROM players WHERE username LIKE '%hero123%'
